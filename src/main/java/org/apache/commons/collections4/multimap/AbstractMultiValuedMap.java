...
public abstract class AbstractMultiValuedMap<K, V> implements MultiValuedMap<K, V> {
     ...
     */
    @Override
    synchronized public Collection<V> get(final K key) {
     ...
     */
    @Override
    synchronized public Collection<V> remove(Object key) {
     ...
     */
    @Override
    synchronized public boolean removeMapping(final Object key, final Object value) {
     ...
     */
    @Override
    synchronized public boolean put(final K key, final V value) {
        Collection<V> coll = getMap().get(key);
        if (coll == null) {
     ...
     */
    @Override
    synchronized public boolean putAll(final Map<? extends K, ? extends V> map) {
        if (map == null) {
            throw new NullPointerException("Map must not be null.");
        }
     ...
     */
    @Override
    synchronized public boolean putAll(final MultiValuedMap<? extends K, ? extends V> map) {
        if (map == null) {
            throw new NullPointerException("Map must not be null.");
        }
        boolean changed = false;
     ...
     */
    @Override
    synchronized public boolean putAll(final K key, final Iterable<? extends V> values) {
        if (values == null) {
